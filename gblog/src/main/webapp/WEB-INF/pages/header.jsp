...
<link rel="stylesheet"
	href="${path }/static/sources/bootstrap/css/bootstrap.min.css">
...
<body>
		...
		<div class="row">
			...
			<div class="headnav-wapper" id="wapper">
				<div class="col-lg-10 col-lg-push-1">
					<div class="navbar navbar-static-top navbar-inverse" id="nav-top"
						 role="navigation">
	...
	<script src="${path }/static/sources/jquery.color-2.1.2.js"></script>
	<script src="${path }/static/sources/bootstrap/js/bootstrap.js"></script>
</body>
</html>